...
# Script to create the full APK installer script v4.1.0
...
# Continue with the rest of the script (I'll need to truncate for now due to length)
# This is just the beginning portion - the full script would be much longer

with open('apk_installer_part1.py', 'w', encoding='utf-8') as f:
    f.write(content)

print("Created partial script file") 